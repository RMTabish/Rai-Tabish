          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {reviews.map((review, index) => (
              <motion.div
                ...
                className="bg-gray-800 rounded-lg shadow-lg p-6 hover:shadow-xl hover:bg-gray-700 transition-shadow duration-300"
              >
                <div className="flex items-center justify-between mb-4">
                  <span className="text-lg font-semibold text-blue-400">{review.client}</span>
                  <div className="flex">
