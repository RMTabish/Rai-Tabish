...
export default function Home() {
  ...
  return (
    <div className="relative w-full min-h-screen bg-black text-white">
      {/* ✅ Move Particles Outside of the Content */}
      <ParticlesBackground />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10">
        ...
        <div className="mt-16 text-center">
          ...
          <a
            ...
            className="inline-flex items-center px-4 py-2 mt-4 border border-gray-600 text-white-600 rounded-full hover:bg-gray-600 hover:text-white transition-colors duration-200 cursor-pointer group"
          >
            <span className="mr-2">Download Resume</span>
            <svg className="w-4 h-4 group-hover:translate-x-1 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 12l6 6M10 18l10-10" />
            </svg>
          </a>
        </div>
      </div>
